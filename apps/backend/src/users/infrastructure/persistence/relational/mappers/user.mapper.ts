...
export class UserMapper {
  static toDomain(raw: UserEntity): User {
    ...
    user.humancode = raw.humancode;
    user.humancodeTime = raw.humancodeTime;
    user.address = raw.address;
    user.telegramUid = raw.telegramUid;
  ...
  static toPersistence(user: User): UserEntity {
    ...
    userEntity.humancode = user.humancode;
    userEntity.humancodeTime = user.humancodeTime;
    userEntity.address = user.address;
    userEntity.telegramUid = user.telegramUid;
